...
import '../model/report_expenditure_revenue_model.dart';
...
class ReportDataResponse extends BaseResponse {
  ...
  factory ReportDataResponse.fromJson(Map<String, dynamic> json) {
    ...
    List<ReportData> reportDataList = (json['data'] as List<dynamic>)
        .map((data) => ReportData.fromJson(data as Map<String, dynamic>))
        .toList();
