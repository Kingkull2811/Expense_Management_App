...
import 'package:viet_wallet/screens/planning/current_finances/current_finances_state.dart';
...
class _CurrentFinancesState extends State<CurrentFinances> {
  ...
  @override
  void initState() {
    _currentFinancesBloc = BlocProvider.of<CurrentFinancesBloc>(context)
      ..add(CurrentFinancesInitEvent());
    super.initState();
  }
