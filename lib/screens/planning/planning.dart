...
class _PlanningPageState extends State<PlanningPage> {
  @override
  void initState() {
    BlocProvider.of<PlanningBloc>(context).add(InitialEvent());
    super.initState();
  }

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<PlanningBloc, PlanningState>(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                  context, AppRoutes.reportPayment);
                            },
                            child: Container(
                              width: 170,
                              height: 150,
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                context,
                                AppRoutes.reportExpenditure,
                                arguments: [
                                  state.listWallet,
                                  state.listExCategory
                                ],
                              );
                            },
                            child: Container(
